...
use crate::core::driver::{
    DriverRegistry,
    MySqlDriverFactory, PostgresDriverFactory, SqliteDriverFactory, DuckDbDriverFactory,
};
...
impl AutoDriverRegistrar {
    ...
    pub fn register_builtin_drivers() {
        ...
        println!("Builtin drivers registered: {:?}", DriverRegistry::all_driver_ids());
    }
    ...
    pub fn auto_register() {
        ...
        #[cfg(debug_assertions)]
        println!("Auto registration complete. Registered drivers: {:?}", 
