...
| `scratchpad/ui/components/ScratchpadPanel.vue`    | ~1330 | 主面板组件（工具栏排序/搜索双模式/回收站/右键菜单/提升确认/拖放导入/文件夹新建/Toast/搜索跳转/大小写/高亮/折叠展开/最近打开/空状态/多选批量/复制粘贴/模板选择/删除撤销/拖拽到编辑器） |
