...
const importMappings = [
  ...
  { from: '@/services/databaseNavigatorLoader', to: '@/modules/database/services/databaseNavigatorLoader' },
  { from: '@/services/mockDatabaseNavigator', to: '@/modules/database/services/mockDatabaseNavigator' },
